...
def live_match(
    pages: int = Query(6, ge=1, le=12, description="Rekrute pages to scrape (1 page ≈ 10 jobs)"),
    user_id: str = Depends(get_current_user_id),
    db: Session = Depends(get_db),
):
    """
...
def get_advice(
    ...
    - Generated by Groq llama-3.1-8b-instant using profile + missing skills from recs.
